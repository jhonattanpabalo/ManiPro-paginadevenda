    ...
    <section id="offer" className="bg-purple-600 text-white py-20">
      <div className="container mx-auto px-6 text-center">
        ...
        <div className="mt-8 bg-white text-gray-800 rounded-xl max-w-lg mx-auto p-8 shadow-2xl">
          ...
          <a href="#" className="mt-8 w-full inline-block bg-pink-500 text-white font-bold text-lg px-8 py-4 rounded-full shadow-lg hover:bg-pink-600 transform hover:scale-105 transition-all">
            👉 Quero Começar Agora
          </a>
